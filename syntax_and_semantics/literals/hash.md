...
Un [dictionnaire](http://crystal-lang.org/api/Hash.html) représente une correspondance entre des clés de type `K` et des valeurs de type `V`. Il est typiquement créé avec un litéral de dictionnaire:
